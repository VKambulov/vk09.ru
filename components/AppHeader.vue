...
<template>
  <header :class="app.header.position || 'left'">
    <div class="menu">
    ...
    <div class="logo">
      <NuxtLink v-if="app.header.logo" to="/">
        <NuxtImg
          class="dark-img"
          :src="app.header.logo.pathDark"
          :alt="app.header.logo.alt"
        />
        <NuxtImg
          class="light-img"
          :src="app.header.logo.path"
          :alt="app.header.logo.alt"
        />
      </NuxtLink>
      <NuxtLink v-else to="/" class="fallback">
        <div>{{ app.title }}</div>
        <div class="subtext">Full Stack Web Developer</div>
      </NuxtLink>
    </div>
...
css({
  header: {
    ...
    '.overlay': {
      ...
      backgroundColor: 'rgba({color.gray.100}, 0.7)',
      ...
      '@dark': {
        backgroundColor: 'rgba({color.gray.900}, 0.7)',
